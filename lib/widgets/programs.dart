...
class ProgramCard extends StatelessWidget{
  ...
  final int time;
  const ProgramCard({super.key, required this.pictureName, required this.title, required this.description, required this.time});
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("$time lessons",style: TextStyle(fontSize: 14,color: Colors.grey),),
            )
          ],
        ),
      ),
